...
and never will. See
[ADR-0001](docs/adr/0001-two-targets-separate-stores.md).
...
[`docs/stability-boundary.md`](docs/stability-boundary.md).
...
Read [`docs/adding-a-model.md`](docs/adding-a-model.md). The short version is:
...
[`docs/operations/`](docs/operations/README.md): its table picks the surface,
and one page each takes a [query](docs/operations/query.md),
[mutation](docs/operations/mutation.md), and
[subscription](docs/operations/subscription.md) from the Rust file through the
